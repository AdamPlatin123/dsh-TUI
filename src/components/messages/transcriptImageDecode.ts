...
function scheduleDecode(signal: AbortSignal, work: () => Promise<TerminalImageSource>, priority: boolean): Promise<TerminalImageSource> {
...
export function makeDecodeTier(maxPixels: number, limit: number) {
