...
const dict = {
  ...
  'effort-preference-downgraded': { zh: '偏好推理强度 {{preferred}} 不被当前模型支持，已就近降档至 {{applied}}', en: 'Preferred reasoning effort {{preferred}} is unavailable on this model; fell back to {{applied}}' },
