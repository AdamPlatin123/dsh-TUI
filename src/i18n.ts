...
const dict = {
  ...
  'egg-status': { zh: '彩蛋开关  {{state}}', en: 'Easter egg  {{state}}' },
  'egg-on': { zh: '已启用', en: 'on' },
  'egg-off': { zh: '已关闭', en: 'off' },
  'egg-hint': { zh: '用法      /easter-egg on|off · 开启后切到梁神模式播放全屏彩蛋', en: 'Use      /easter-egg on|off · when on, Liangshen mode plays a full-screen easter egg' },
  'egg-enabled': { zh: '彩蛋已开启：切到梁神模式时将播放全屏彩蛋 🎉', en: 'Easter egg enabled: switching to Liangshen mode plays the full-screen celebration 🎉' },
  'egg-disabled': { zh: '彩蛋已关闭', en: 'Easter egg disabled' },
  'egg-pref-write-failed': { zh: '无法写入 ~/.dsh-tui/easter-egg.json，开关未保存', en: 'Cannot write ~/.dsh-tui/easter-egg.json, toggle not saved' },
  'egg-usage': { zh: '用法：/easter-egg on | off | status', en: 'Usage: /easter-egg on | off | status' },
  ...
  'cmd-desc-easter-egg': { zh: '切换梁神模式彩蛋开关（on/off/status）' },
